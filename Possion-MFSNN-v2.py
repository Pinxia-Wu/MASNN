...
np.save('./data/predi-v2', u_predi_numpy)
np.save('./data/exact-v2', u_exact_numpy)
np.save('./data/error-v2', u_error_numpy)
np.save('./data/gridx-v2', x_eva_numpy)
...
np.save('./data/predi-DFT-v2', u_predi)
np.save('./data/exact-DFT-v2', u_exact)
